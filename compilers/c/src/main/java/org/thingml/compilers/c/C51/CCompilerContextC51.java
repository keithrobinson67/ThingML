 ...
 */
public class CCompilerContextC51 extends CCompilerContext {

    public CCompilerContextC51(ThingMLCompiler c) {
        super(c);
    }
    ...
    public String getCType(Type t) {    	
        if (AnnotatedElementHelper.hasAnnotation(t, "8051_type")) {
            return AnnotatedElementHelper.annotation(t, "8051_type").get(0);
        } 
